...
--
-- Isäntä: db
-- Luontiaika: 19.02.2026 klo 12:45
...
--
-- Tietokanta: `deerhunter`
--
CREATE DATABASE IF NOT EXISTS `deerhunter` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `deerhunter`;

-- --------------------------------------------------------

--
-- Rakenne taululle `lajit`
--

CREATE TABLE `lajit` (
  `id` int NOT NULL,
  `lajit` char(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Vedos taulusta `lajit`
--

INSERT INTO `lajit` (`id`, `lajit`) VALUES
(1, 'Kauris'),
(2, 'Hirvi'),
(3, 'Metsajanis'),
(4, 'Rusakko'),
...
--
-- Rakenne taululle `metsastajat`
--

CREATE TABLE `metsastajat` (
  `numero` varchar(20) NOT NULL,
  `nimi` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Vedos taulusta `metsastajat`
--

INSERT INTO `metsastajat` (`numero`, `nimi`) VALUES
('1234', 'Pentti Ojaniemi'),
('1235', 'Risto Reipas');

-- --------------------------------------------------------

--
-- Rakenne taululle `paikkakunnat`
--

CREATE TABLE `paikkakunnat` (
  `id` int NOT NULL,
  `kunta` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Vedos taulusta `paikkakunnat`
--

INSERT INTO `paikkakunnat` (`id`, `kunta`) VALUES
(1, 'Sahalahti'),
(2, 'Peraseinajoki'),
(3, 'Muu maa');
...
CREATE TABLE `saaliit` (
  ...
  `lajiId` int NOT NULL,
  `metsastajaId` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Vedos taulusta `saaliit`
--

INSERT INTO `saaliit` (`id`, `pvm`, `paikkaId`, `lajiId`, `metsastajaId`) VALUES
(1, '2006-02-09', 1, 1, '1234'),
(2, '2006-02-10', 2, 2, '1234'),
(3, '2006-02-09', 2, 2, '1234'),
(4, '2006-02-09', 3, 1, '1235'),
(5, '2006-02-09', 1, 4, '1235'),
(6, '2006-02-09', 2, 4, '1234');
...
--
-- Indeksit taulukolle `lajit`
--
ALTER TABLE `lajit`
  ADD PRIMARY KEY (`id`);

--
-- Indeksit taulukolle `metsastajat`
--
ALTER TABLE `metsastajat`
  ADD PRIMARY KEY (`numero`);

--
-- Indeksit taulukolle `paikkakunnat`
--
ALTER TABLE `paikkakunnat`
  ADD PRIMARY KEY (`id`);

--
-- Indeksit taulukolle `saaliit`
--
ALTER TABLE `saaliit`
  ADD PRIMARY KEY (`id`),
  ADD KEY `paikkaId` (`paikkaId`),
  ADD KEY `lajiId` (`lajiId`),
  ADD KEY `metsastajaId` (`metsastajaId`);
...
--
-- AUTO_INCREMENT for table `lajit`
--
ALTER TABLE `lajit`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `paikkakunnat`
--
ALTER TABLE `paikkakunnat`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `saaliit`
--
ALTER TABLE `saaliit`
...
--
-- Rajoitteet taululle `saaliit`
--
ALTER TABLE `saaliit`
  ADD CONSTRAINT `saaliit_ibfk_1` FOREIGN KEY (`paikkaId`) REFERENCES `paikkakunnat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `saaliit_ibfk_2` FOREIGN KEY (`lajiId`) REFERENCES `lajit` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `saaliit_ibfk_3` FOREIGN KEY (`metsastajaId`) REFERENCES `metsastajat` (`numero`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Tietokanta: `kalakilpa`
--
CREATE DATABASE IF NOT EXISTS `kalakilpa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `kalakilpa`;

-- --------------------------------------------------------

--
-- Rakenne taululle `kala`
--
...
INSERT INTO `kala` (`id`, `laji`, `pituus`, `poikaid`) VALUES
(1, 'Ahven', 43, 3),
(2, 'Siika', 52, 2);
...
--
-- Vedos taulusta `poika`
--

INSERT INTO `poika` (`id`, `nimi`, `ika`) VALUES
(2, 'Pelle', 7),
(3, 'Kalle', 5),
(7, 'Ville', 6),
(8, 'Pasi', 9);
...
--
-- Indeksit taulukolle `kala`
--
ALTER TABLE `kala`
  ADD PRIMARY KEY (`id`),
  ADD KEY `poikaid` (`poikaid`);

--
-- Indeksit taulukolle `poika`
--
ALTER TABLE `poika`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `poika`
--
ALTER TABLE `poika`
...
--
-- Rajoitteet taululle `kala`
--
ALTER TABLE `kala`
  ADD CONSTRAINT `kala_ibfk_1` FOREIGN KEY (`poikaid`) REFERENCES `poika` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Tietokanta: `lounas`
--
CREATE DATABASE IF NOT EXISTS `lounas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `lounas`;
